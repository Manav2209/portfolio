      ...
      <div className="flex flex-col items-center px-10 ">
        <div>
          ...
          <div className="flex gap-4 my-8">
            ...
            <button
              onClick={() => {
                window.location.href = "mailto:manavpanchal2854@gmail.com";
              }}
          ...
          <div className="flex md:flex-row flex-col ">
            <div>
              ...
              <div className="flex md:flex-col gap-3 border-l-2 md:border-none border-[#bd93f9] pl-3 md:ml-0 ml-3 md:pl-0 md:h-fit h-[40px] items-center md:items-start">
                <FaLinkedin
                  onClick={() =>
                    window.open("https://www.linkedin.com/in/manav--panchal/")
                  }
                  className="text-[#6272a4] text-3xl cursor-pointer hover:text-[#bd93f9] transition-all duration-300"
                />
                <FaGithub
                  onClick={() => window.open("https://github.com/Manav2209")}
                  className="text-[#6272a4] text-3xl cursor-pointer hover:text-[#bd93f9] transition-all duration-300"
                />
              </div>
            </div>
            <blockquote className="mt-[-20px] w-[300px] pl-6 text-sm italic text-[#b2dbf2]">
              <TextGenerateEffect words="Hi, I'm Manav. I'm 20 yrs old and a Full Stack Developer.I love to  code and I love to create. I'm a creative thinker and I love to solve problems." />
            </blockquote>
          </div>
        </div>
      </div>
